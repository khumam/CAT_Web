    ...
    $(document).ready(function() {
        ...
        var tabeldata = $('#dataTables').DataTable({
            ...
            columns: [{
                ...
                {
                    render: function(data, type, row) {
                        return "<div class='btn-group'><button data-nomor='" + row.nomor_user + "' data-nama='" + row.nama_user + "' data-id = '" + row.kd_user + "' class='btn btn-xs btn-success btn-detail'>Detail</button></div>";
                    }
                }
            ]
                ...
                success: function(data) {
                    if (data.length == 0) {
                        ...
                        $.each(data, function(index, value) {
                            ...
                            var jam = dates.getHours() + ':' + dates.getMinutes() + ' WIB'
                            content += "<li class='list-group-item'>" +
                                "<div class='row'><div class='col-10'><b>" + value.judul + "</b><br>Pada: " + tgl + '/' + bln + '/' + thn + ', ' + jam + "</div><div class='col-2'><a href='nilai.php?idsiswa=" + value.kd_peserta + "&idkodesoal=" + value.kd_judul_tes + "&sessionid=" + value.session_id + "' class='btn btn-xs btn-info float-right'>Lihat hasil</a></div></div></li>";
                        });
